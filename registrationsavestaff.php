...
if($errmsg1 != "") {
    echo "<font size=5 color=red>$errmsg1<p />
         <a href=\"javascript: history.back()\">Go back to edit</a></font>";
    ...
    $strSQL .="VALUES ";
    $strSQL .="('".'0'."','".'0'."','".$_POST["fname"]."','".$_POST["lname"]."','".$_POST["username"]."','".$_POST["password"]."','".$_POST["email"]."','".$_POST["tel"]."','".$_POST["gender"]."','".$_POST["birthdate"]."','1','".$_POST["question"]."','".$_POST["answer"]."'";
    $strSQL .=",'".$filepath."')";
    $objQuery = mysql_query($strSQL,$objConnect);
    $lastID = mysql_insert_id();
    if($objQuery){
        $mname=$_POST['username'];
        echo "<script type='text/javascript'>window.top.location='homepage.php#popup1';</script>";
...
<script>
    ...
    $.post("homepage.php/#popup1", {mid:mid, function(results){
