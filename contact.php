...
<body id="page-top">
    ...
    <div class="container">
      <img src="img/contactsym.png" class="symbol" />
    ...
    <div class="container">
        <section class="component page-description">
            ...
            <div class="component-content">
                ...
                <div class="intro">
                    <div class="rich-text"><p><strong>Museum Guide</strong>
                        is provided to the group visit for a better experience along your route at Chula Museum. Please make a reservation for a museum guide in advance for your group visit at 02-123-4567
                    </div>
                </div>
...
<div id="checklogin" class="overlay">
    ...
    if($rs){
        ...
        <input type=\"hidden\" value=\"<?php echo \$username?>\" name=\"username\" />";
            ...
            if($row['username']==$username && $row['password']!=$password){
                echo "<a href='./contact.php#popup2'>ForgetPassword?</a>";
            }
            else{
                $non="true";
            }
...
<div id="popup2" class="overlay">
    ...
    <div class="content">
        ...
        <a href="./contact.php" class="button">cancel</a>
...
<div id="popup3" class="overlay">
    ...
    <div class="content">
        ...
        <a href=\"./contact.php\" class=\"button\">cancel</a>";
            ...
            echo "email not found <a href='./contact.php#popup2'>Go back</a> <br>";
...
//        echo $answer;
        $var = $_POST['var'];
//        echo $var;
        $say = "your answer is not correct <br><a href='./contact.php#popup2'>Try Again</a>";
...
//        echo $newrepass;
            ...
            if($newpass==$newrepass){
                ...
                echo "new password and confirm new password not match <br><a href='./contact.php#popup3'>Go back</a> ";
            }
