        ...
        <div class="row">
            ...
            <div class="col-sm-9"> 
                <div class="rightpanel">
                    <h2 style="margin-left:20px">Email Preferences</h2><hr>
                   
                    <div class="inputField">
                        Subcribe to: <br><br>
                       <input type="checkbox" name="checkBoxNews" value="email"> News emails 
                        <br>
                        Find out first about new exhibitions and events.
                    </div>
